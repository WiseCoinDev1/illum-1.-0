...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "IlluminumNetwork") type = IlluminumNetwork;
    if(strType == "IlluminumNetworkVariable") type = IlluminumNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == IlluminumNetwork) s = "IlluminumNetwork";
    if(type == IlluminumNetworkVariable) s = "IlluminumNetworkVariable";
