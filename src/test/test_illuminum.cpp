...
#define BOOST_TEST_MODULE Illuminum Test Suite

#include "test_illuminum.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_illuminum_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
